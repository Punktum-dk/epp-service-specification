...
- 5.3.1 2026-05-27
  ...
  - Improved error message on [create contact](#create-contact)

- 5.3.0 2026-03-19

  > 🚨 The following functional changes are included in this release but will not be **activated until 2026-07-01**. Integrators should prepare accordingly.
  ...
  - The following extensions are no longer supported by the service. Documentation has been updated to reflect their deprecated status. They remain present in the XSD for the time being:
    - `dkhm:authInfoExDate`
    - `dkhm:delDate`
    - `dkhm:url`
...
- 4.2 2021-10-21
  ...
  - Added missing example of withdraw response
...
> ⚠️ **Deprecated** — This extension has been superseded by the [`dkhm:authInfo`](#dkhmauthinfo) extension and is no longer supported by the service. It remains present in the XSD for the time being.
...
> ⚠️ **Deprecated** — This extension has been superseded by the `pendingDeletionDate` advisory in the [`dkhm:domainAdvisory`](#dkhmdomainadvisory) extension and is no longer supported by the service. It remains present in the XSD for the time being.
...
> ⚠️ **Deprecated** — This extension is no longer supported by the service. It remains present in the XSD for the time being.
...
<epp xmlns="urn:ietf:params:xml:ns:epp-1.0">
    <greeting>
        <svID>DK Hostmaster EPP Service (production): 5.3.1</svID>
...
The outcome can be one of several for [create domain](#create-domain). Please see the [Poll Message Reference Guide](Poll-Message-Reference-Guide.md) for the complete list of poll messages.
...
| `pendingDelete`            | Deletion is pending, see [delete domain](#delete-domain). An advisory date is applicable via the extension [`dkhm:domainAdvisory`](#dkhmdomainadvisory)                                                                                |
